 ...
 * 
 */
public class AnimationMob extends Actor {
	...
	public AnimationMob() {
		...
		addListener(new InputListener() {
			public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
				if (!isRemoving) {
					AnimationMob.this.fire(Pools.obtain(MobTouchedEvent.class));
					isRemoving = true;
				}
				return false;
			}
	...
	public AnimationMob init(AnimationActor animation, float speed) {
...
*/
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        TextureRegion region = animation.animation.getKeyFrame(stateTime,true);
